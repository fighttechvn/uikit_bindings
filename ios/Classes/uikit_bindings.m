...
Protocol* _NativeLibrary_NSExtensionRequestHandling(void) { return @protocol(NSExtensionRequestHandling); }
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline _NativeLibrary_wrapListenerBlock_18v1jvf(ListenerTrampoline block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline _NativeLibrary_wrapBlockingBlock_18v1jvf(
...
Protocol* _NativeLibrary_UIUserActivityRestoring(void) { return @protocol(UIUserActivityRestoring); }
...
Protocol* _NativeLibrary_UIContentContainer(void) { return @protocol(UIContentContainer); }

Protocol* _NativeLibrary_UIFocusEnvironment(void) { return @protocol(UIFocusEnvironment); }

typedef id  (^ProtocolTrampoline_3)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef NSItemProviderRepresentationVisibility  (^ProtocolTrampoline_5)(void * sel, id arg1);
__attribute__((visibility("default"))) __attribute__((used))
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_1 _NativeLibrary_wrapListenerBlock_pfv6jd(ListenerTrampoline_1 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_1 _NativeLibrary_wrapBlockingBlock_pfv6jd(
...
typedef id  (^ProtocolTrampoline_7)(void * sel, id arg1, id arg2, id * arg3);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef void  (^ListenerTrampoline_2)();
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_2 _NativeLibrary_wrapListenerBlock_1pl9qdv(ListenerTrampoline_2 block) NS_RETURNS_RETAINED {
  return ^void() {
    objc_retainBlock(block);
    block();
  };
...
typedef void  (^BlockingTrampoline_2)(void * waiter);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_2 _NativeLibrary_wrapBlockingBlock_1pl9qdv(
...
typedef void  (^ListenerTrampoline_3)(BOOL arg0);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_3 _NativeLibrary_wrapListenerBlock_1s56lr9(ListenerTrampoline_3 block) NS_RETURNS_RETAINED {
...
typedef void  (^BlockingTrampoline_3)(void * waiter, BOOL arg0);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_3 _NativeLibrary_wrapBlockingBlock_1s56lr9(
...
Protocol* _NativeLibrary_UIStateRestoring(void) { return @protocol(UIStateRestoring); }

Protocol* _NativeLibrary_UIViewControllerRestoration(void) { return @protocol(UIViewControllerRestoration); }

Protocol* _NativeLibrary_UIViewControllerTransitioningDelegate(void) { return @protocol(UIViewControllerTransitioningDelegate); }

Protocol* _NativeLibrary_UILayoutSupport(void) { return @protocol(UILayoutSupport); }

Protocol* _NativeLibrary_UIViewControllerPreviewing(void) { return @protocol(UIViewControllerPreviewing); }

Protocol* _NativeLibrary_UIViewControllerPreviewingDelegate(void) { return @protocol(UIViewControllerPreviewingDelegate); }

Protocol* _NativeLibrary_UINavigationControllerDelegate(void) { return @protocol(UINavigationControllerDelegate); }

Protocol* _NativeLibrary_UIFocusItemScrollableContainer(void) { return @protocol(UIFocusItemScrollableContainer); }

typedef struct CGPoint  (^ProtocolTrampoline_8)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef void  (^ListenerTrampoline_4)(void * arg0, struct CGPoint arg1);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_4 _NativeLibrary_wrapListenerBlock_1bktu2(ListenerTrampoline_4 block) NS_RETURNS_RETAINED {
...
typedef void  (^BlockingTrampoline_4)(void * waiter, void * arg0, struct CGPoint arg1);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_4 _NativeLibrary_wrapBlockingBlock_1bktu2(
...
typedef void  (^ProtocolTrampoline_9)(void * sel, struct CGPoint arg1);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef struct CGSize  (^ProtocolTrampoline_10)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
struct CGSize  _NativeLibrary_protocolTrampoline_1j20mp(id target, void * sel) {
  return ((ProtocolTrampoline_10)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel);
}

Protocol* _NativeLibrary_UIScrollViewDelegate(void) { return @protocol(UIScrollViewDelegate); }

typedef id  (^ProtocolTrampoline_11)(void * sel, struct CGRect arg1);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef struct CGSize  (^ProtocolTrampoline_12)(void * sel, id arg1, struct CGSize arg2);
__attribute__((visibility("default"))) __attribute__((used))
struct CGSize  _NativeLibrary_protocolTrampoline_gnbb7x(id target, void * sel, id arg1, struct CGSize arg2) {
  return ((ProtocolTrampoline_12)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel, arg1, arg2);
}

Protocol* _NativeLibrary_UIViewControllerTransitionCoordinator(void) { return @protocol(UIViewControllerTransitionCoordinator); }

typedef void  (^ListenerTrampoline_5)(void * arg0, struct CGSize arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_5 _NativeLibrary_wrapListenerBlock_1rn6eap(ListenerTrampoline_5 block) NS_RETURNS_RETAINED {
...
typedef void  (^BlockingTrampoline_5)(void * waiter, void * arg0, struct CGSize arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_5 _NativeLibrary_wrapBlockingBlock_1rn6eap(
...
typedef void  (^ProtocolTrampoline_13)(void * sel, struct CGSize arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
void  _NativeLibrary_protocolTrampoline_1rn6eap(id target, void * sel, struct CGSize arg1, id arg2) {
  return ((ProtocolTrampoline_13)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel, arg1, arg2);
}

typedef void  (^ListenerTrampoline_6)(void * arg0, id arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_6 _NativeLibrary_wrapListenerBlock_fjrv01(ListenerTrampoline_6 block) NS_RETURNS_RETAINED {
...
typedef void  (^BlockingTrampoline_6)(void * waiter, void * arg0, id arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_6 _NativeLibrary_wrapBlockingBlock_fjrv01(
...
typedef void  (^ProtocolTrampoline_14)(void * sel, id arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef void  (^ListenerTrampoline_7)(void * arg0);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_7 _NativeLibrary_wrapListenerBlock_ovsamd(ListenerTrampoline_7 block) NS_RETURNS_RETAINED {
...
typedef void  (^BlockingTrampoline_7)(void * waiter, void * arg0);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_7 _NativeLibrary_wrapBlockingBlock_ovsamd(
...
typedef void  (^ProtocolTrampoline_15)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef BOOL  (^ProtocolTrampoline_16)(void * sel, id arg1);
__attribute__((visibility("default"))) __attribute__((used))
...
Protocol* _NativeLibrary_UIInteraction(void) { return @protocol(UIInteraction); }

typedef struct CGRect  (^ProtocolTrampoline_17)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef struct CGAffineTransform  (^ProtocolTrampoline_18)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
struct CGAffineTransform  _NativeLibrary_protocolTrampoline_8o6he9(id target, void * sel) {
  return ((ProtocolTrampoline_18)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel);
}

typedef void  (^ListenerTrampoline_8)(void * arg0, struct CGAffineTransform arg1);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_8 _NativeLibrary_wrapListenerBlock_1lznlw3(ListenerTrampoline_8 block) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_8 _NativeLibrary_wrapBlockingBlock_1lznlw3(
...
typedef void  (^ProtocolTrampoline_19)(void * sel, struct CGAffineTransform arg1);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef UIDynamicItemCollisionBoundsType  (^ProtocolTrampoline_20)(void * sel);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef struct CGPoint  (^ProtocolTrampoline_21)(void * sel, struct CGPoint arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
struct CGPoint  _NativeLibrary_protocolTrampoline_17ipln5(id target, void * sel, struct CGPoint arg1, id arg2) {
  return ((ProtocolTrampoline_21)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel, arg1, arg2);
}

typedef struct CGRect  (^ProtocolTrampoline_22)(void * sel, struct CGRect arg1, id arg2);
__attribute__((visibility("default"))) __attribute__((used))
...
typedef void  (^ListenerTrampoline_9)(void * arg0, id arg1, struct CGContext * arg2);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_9 _NativeLibrary_wrapListenerBlock_qvcerx(ListenerTrampoline_9 block) NS_RETURNS_RETAINED {
...
typedef void  (^BlockingTrampoline_9)(void * waiter, void * arg0, id arg1, struct CGContext * arg2);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_9 _NativeLibrary_wrapBlockingBlock_qvcerx(
...
typedef void  (^ProtocolTrampoline_23)(void * sel, id arg1, struct CGContext * arg2);
__attribute__((visibility("default"))) __attribute__((used))
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_10 _NativeLibrary_wrapListenerBlock_1l4hxwm(ListenerTrampoline_10 block) NS_RETURNS_RETAINED {
  return ^void(void * arg0, id arg1) {
    objc_retainBlock(block);
...
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_10 _NativeLibrary_wrapBlockingBlock_1l4hxwm(
...
typedef void  (^ProtocolTrampoline_24)(void * sel, id arg1);
__attribute__((visibility("default"))) __attribute__((used))
void  _NativeLibrary_protocolTrampoline_1l4hxwm(id target, void * sel, id arg1) {
  return ((ProtocolTrampoline_24)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel, arg1);
}

Protocol* _NativeLibrary_CAMediaTiming(void) { return @protocol(CAMediaTiming); }

typedef void  (^ListenerTrampoline_11)(id arg0, id arg1, struct objc_selector * arg2, UIControlEvents arg3, BOOL * arg4);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_11 _NativeLibrary_wrapListenerBlock_1cxqo1i(ListenerTrampoline_11 block) NS_RETURNS_RETAINED {
...
typedef void  (^BlockingTrampoline_11)(void * waiter, id arg0, id arg1, struct objc_selector * arg2, UIControlEvents arg3, BOOL * arg4);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_11 _NativeLibrary_wrapBlockingBlock_1cxqo1i(
...
Protocol* _NativeLibrary_UITextInputTraits(void) { return @protocol(UITextInputTraits); }

Protocol* _NativeLibrary_UIKeyInput(void) { return @protocol(UIKeyInput); }

Protocol* _NativeLibrary_UITextInput(void) { return @protocol(UITextInput); }

Protocol* _NativeLibrary_UIContentSizeCategoryAdjusting(void) { return @protocol(UIContentSizeCategoryAdjusting); }

typedef void  (^ListenerTrampoline_12)(id arg0);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_12 _NativeLibrary_wrapListenerBlock_xtuoz7(ListenerTrampoline_12 block) NS_RETURNS_RETAINED {
  return ^void(id arg0) {
    objc_retainBlock(block);
...
typedef void  (^BlockingTrampoline_12)(void * waiter, id arg0);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_12 _NativeLibrary_wrapBlockingBlock_xtuoz7(
...
Protocol* _NativeLibrary_UIApplicationDelegate(void) { return @protocol(UIApplicationDelegate); }

typedef void  (^ListenerTrampoline_13)(void * arg0, BOOL arg1);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_13 _NativeLibrary_wrapListenerBlock_10lndml(ListenerTrampoline_13 block) NS_RETURNS_RETAINED {
...
typedef void  (^BlockingTrampoline_13)(void * waiter, void * arg0, BOOL arg1);
__attribute__((visibility("default"))) __attribute__((used))
ListenerTrampoline_13 _NativeLibrary_wrapBlockingBlock_10lndml(
...
typedef void  (^ProtocolTrampoline_25)(void * sel, BOOL arg1);
__attribute__((visibility("default"))) __attribute__((used))
void  _NativeLibrary_protocolTrampoline_10lndml(id target, void * sel, BOOL arg1) {
  return ((ProtocolTrampoline_25)((id (*)(id, SEL, SEL))objc_msgSend)(target, @selector(getDOBJCDartProtocolMethodForSelector:), sel))(sel, arg1);
}
